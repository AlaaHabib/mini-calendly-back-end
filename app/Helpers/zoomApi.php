...
class ZoomApiHelper{
	...
	public static function createZoomMeeting($meetingConfig = []){
		$jwtToken = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOm51bGwsImlzcyI6IlJ2a3pTRkdHVFJLa1JRYkkxZFZGOWciLCJleHAiOjE2NzUwMTkyNDgsImlhdCI6MTY3NDQxNDQ0OX0.JrsC_xZnAV3cWGaY92iltPTS03flj729qr2aKcgfzzo";
		...
		$zoomUserId = "RYRl9v9yS_eJ0DMwNfs6EQ";
